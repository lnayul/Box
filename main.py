...
# 3. 한국 시간 기준 날짜 계산
# ============================================================
# Streamlit Cloud 서버의 시간은 한국 시간과 다를 수 있습니다.
# 따라서 반드시 한국 시간(Asia/Seoul)을 기준으로 계산합니다.
...
# 6. KOBIS API 호출 함수
# ============================================================
# 같은 날짜를 다시 조회하면 1시간 동안 저장된 데이터를 사용합니다.
...
# 13. 영화명에 트로피 표시
# ============================================================
# 누적관객이 100만 명 이상이면 영화명 뒤에 🏆를 붙입니다.
...
# ============================================================
# 20. 관객수가 많은 순서로 TOP 5 정렬
# ============================================================
# 중요!
# KOBIS의 '순위(rank)'가 아니라
# 실제 '해당일 관객수(audiCnt)'를 기준으로 정렬합니다.
#
# 따라서 관객수가 가장 많은 영화가 항상 첫 번째에 나옵니다.
# 예: 오디세이 → 2위 영화 → 3위 영화 → ...
